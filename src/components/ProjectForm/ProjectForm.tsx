...
// --- Moved out of ProjectForm and memoized ---
...
export const ProjectForm: React.FC = () => {
  ...
  // TypewriterLabel is at top level
  // Input and TextArea are now at top level
      ...
      return (
        <div className="conversational-step" style={{ alignItems: "center" }}>
          ...
          <p style={{ color: "#A0AEC0", textAlign: "center", maxWidth: 560 }}>
            You can generate the config file now. You can also go back to edit anything.
          </p>
          <div style={{ width: "100%", display: "flex", gap: ".5rem", marginTop: "1.2rem" }}>
            <button className="prev-button" onClick={goToPrevPhase}><FaArrowLeft /> Back</button>
            <button className="generate-button" onClick={handleGenerateJson} style={{ marginLeft: "auto" }}><FaFileDownload /> Download JSON</button>
          </div>
        </div>
      );
    }
